...
function ServiceCard({
    ...
    return (
        ...
        >
            ...
            {/* Arrow */}
            <div className="mt-6 flex items-center gap-2 text-sm font-semibold text-[#EA580C] opacity-0 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-1">
                Batafsil
